...
def train_model(data, model, epochs, model_names):
...
def divide_data_to_sets(data):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.088, random_state=832272)
...
def get_transformed_data(X_train, X_test, y_train, y_test):
...
if __name__ == '__main__':
    ...
    X_train, X_test, y_train, y_test = divide_data_to_sets(data)
    X_train, X_test, y_train, y_test = preprocess_data(X_train, X_test, y_train, y_test)
    data_train, data_test = get_transformed_data(X_train, X_test, y_train, y_test)
    ...
    history, model = train_model(data_train, model, epochs, model_names)
